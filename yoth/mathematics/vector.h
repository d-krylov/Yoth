...
template <typename T> class Vector2 : public VectorType2<T> {
public:
...
template <typename T> class Vector3 : public VectorType3<T> {
public:
  using base_type = VectorType3<T>;

  Vector3() = default;
  template <typename U> Vector3(U v0, U v1, U v2) : base_type(T(v0), T(v1), T(v2)) {}
  template <typename U> Vector3(const Vector2<U> &v, U t) : base_type(T(v.x), T(v.y), T(t)) {}
...
template <typename T> class Vector4 : public VectorType4<T> {
public:
  using base_type = VectorType4<T>;

  Vector4() = default;
  template <typename U> Vector4(U v0, U v1, U v2, U v3) : base_type(T(v0), T(v1), T(v2), T(v3)) {}
  template <typename U> Vector4(const Vector3<U> &v, U t) : base_type(T(v.x), T(v.y), T(v.z), T(t)) {}
  template <typename U> Vector4(U t, const Vector3<U> &v) : base_type(T(t), T(v.x), T(v.y), T(v.z)) {}
