...
public:
  ...
  template <typename U> explicit Vector2(U v) : VectorType<T, 2, Vector2>(T(v)) {}
};
...
public:
  ...
  template <typename U> explicit Vector3(U v) : VectorType<T, 3, Vector3>(T(v)) {}
};
...
public:
  ...
  template <typename U> explicit Vector4(U v) : VectorType<T, 4, Vector4>(T(v)) {}
};
